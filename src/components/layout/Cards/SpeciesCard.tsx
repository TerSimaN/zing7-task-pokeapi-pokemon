...
const SpeciesCard = ({ pokemon }: { pokemon: PokeAPI.Pokemon.Pokemon }) => {
    return (
        <div className="bg-gray-50 border border-gray-100 shadow-md rounded-lg md:p-6 p-4 max-w-full">
            ...
            <div className="divide-y divide-gray-200 mt-2">
                <dl className="flex items-center justify-between gap-4 py-2">
                    ...
                    <dd className="font-inter font-normal text-sm text-gray-500 capitalize">{pokemon.species.name}</dd>
                </dl>
                <dl className="flex items-center justify-between gap-4 py-2">
                    ...
                    <dd className="font-inter font-normal text-sm text-gray-500 hover:underline">
                        <Link href={pokemon.species.url}>{pokemon.species.url}</Link>
                    </dd>
                </dl>
            </div>
        </div>
