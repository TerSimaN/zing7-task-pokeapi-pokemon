...
const PastTypesTableRow = (props: { pastType: PokeAPI.Pokemon.PokemonTypePast, index: number }) => {
        ...
        <>
            <tr className="odd:bg-white even:bg-gray-50 border-b">
                ...
                <td className="px-6 py-4">
                    <Link href={props.pastType.generation.url} className="font-medium text-blue-600 hover:underline">{props.pastType.generation.url}</Link>
                </td>
                <td className="px-6 py-4">
                            ...
                            <tbody>
                                {props.pastType.types.map((type, index) => (
                                    <tr key={index} className="odd:bg-white even:bg-gray-50 border-b whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-4">
                                            <Link href={type.type.url} className="font-medium text-blue-600 hover:underline">{type.type.url}</Link>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
