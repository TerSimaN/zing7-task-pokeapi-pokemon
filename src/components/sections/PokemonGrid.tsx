                        ...
                        <article key={index} className="bg-white border border-gray-200 rounded-lg shadow-md p-4">
                            ...
                            <div className="flex items-center gap-2 mb-5">
                                {pokemon.types.map((type, index) => {
                                    ...
                                    return (
                                        <span key={index} className="inline-flex items-center bg-gray-100 rounded font-inter font-medium text-xs text-gray-500 pl-1.5 pr-2 py-1 capitalize select-none hover:bg-gray-200 hover:text-gray-600">
                                            <Image src={typeIcon.typeIconSrc} alt={typeIcon.typeIconAlt} className="size-5 me-1" />
                                            {type.type.name}
                                        </span>
                                    )
                                })}
